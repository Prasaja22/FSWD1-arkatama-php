<?php
    ...
    $bio = "a 5th semester student majoring in business information systems
    from the State Polytechnic of Malang. Have an interest in 
    the world of website and Android-based application development. 
    Able to create web applications using the Laravel framework and Android 
